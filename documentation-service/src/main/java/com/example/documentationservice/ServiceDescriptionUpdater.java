...
public class ServiceDescriptionUpdater {
	...
	public void refreshSwaggerConfigurations() {
		...
		discoveryClient.getServices().stream().forEach( serviceId -> { 
			...
			ServiceInstance serviceInstance = balancerClient.choose(serviceId);
			...
			if (serviceInstance == null) {
				...
				logger.info("Service Definition Context Refreshed at :  {} for this service {} and the URL is {}", LocalDate.now(),
						serviceId, serviceInstance.getUri());
			}
		});
